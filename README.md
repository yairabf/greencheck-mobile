...
Detailed operational and release documentation lives under `docs/`:

- QA matrix and runs: `docs/qa/`
- Release and rollout: `docs/release/`
- Security notes: `docs/security/`
- Firestore rules/indexes and testing: `docs/firestore-rules-test-plan.md`
